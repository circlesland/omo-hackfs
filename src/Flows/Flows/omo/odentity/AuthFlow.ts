...
export function addAuthProviderMailFlow() {
  return new ProcessBuilder<TrustContext>("omo.safe.addAuthProviderMailFlow")
...
export function removeAuthProviderMailFlow() {
  return new ProcessBuilder<TrustContext>("omo.safe.removeAuthProviderMailFlow")
...
export function addAuthProviderSeedPhraseFlow() {
  return new ProcessBuilder<TrustContext>(
