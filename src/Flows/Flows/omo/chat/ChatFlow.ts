...
import { TrustContext } from "../safe/TrustContext";

export function addChatRoomFlow() {
  return new ProcessBuilder<TrustContext>("omo.chat.addChatRoomFlow")
...
export function removeChatRoomFlow() {
  return new ProcessBuilder<TrustContext>("omo.chat.removeChatRoomFlow")
...
export function sendMessageFlow() {
  return new ProcessBuilder<TrustContext>("omo.chat.sendMessageFlow")
